...
class RtpService: NSObject {
    ...
    private var _rtmpConnection: RTMPConnection = .init()
    ...
    func sendCameraStatusToDart() {
        ...
        do {
            let reply: [String: String] = try [
                "streamState": String(decoding: JSONEncoder().encode(streamingState), as: UTF8.self),
            ]
    ...
    func setupSession() {
        ...
        case "off": stabilizationMode = .off
        case "standard": stabilizationMode = .standard
        case "cinematic": stabilizationMode = .cinematic
        case "auto": stabilizationMode = .auto
        default:
        ...
        case "baseline": profileLevel = kVTProfileLevel_H264_Baseline_AutoLevel
        case "main": profileLevel = kVTProfileLevel_H264_Main_AutoLevel
        case "high": profileLevel = kVTProfileLevel_H264_High_AutoLevel
        default:
    ...
    @objc
    private func _onOrientationChange(_: Notification) {
        _onOrientationChange()
        sendCameraStatusToDart()
    }

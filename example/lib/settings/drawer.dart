            ...
            builder: (context, streamingState) {
              return ListView(
                children: [
                  ...
                  Visibility(
                      visible: Platform.isIOS, child: H264ProfileOption(streamer, streamingState)),
...
class VideoResolutionsOption extends OptionsWidget {
  const VideoResolutionsOption(FlutterRtmpStreamer streamer, StreamingState streamingState,
      {Key? key})
      : super(streamer, streamingState, key: key);
    ...
    return SettingsOption(
      ...
      onTap: () => Navigator.of(context).push(MaterialPageRoute(
          builder: (BuildContext context) => FutureListDrawer<Resolution>(
                ...
                onSelected: (item) => streamer.changeStreamingSettings(
...
class VideoBitrateOption extends OptionsWidget {
  const VideoBitrateOption(FlutterRtmpStreamer streamer, StreamingState streamingState, {Key? key})
      : super(streamer, streamingState, key: key);
  ...
  @override
  Widget build(BuildContext context) {
    final selected = bitrates.firstWhere(
        (b) => b.value == streamingState.streamingSettings.videoBitrate,
...
class CameraFacingOption extends OptionsWidget {
  ...
  const CameraFacingOption(FlutterRtmpStreamer streamer, StreamingState streamingState, {Key? key})
      : super(streamer, streamingState, key: key);

  @override
  Widget build(BuildContext context) {
    final selected = list.firstWhere(
        (b) => b.value == streamingState.streamingSettings.cameraFacing,
...
class VideoFPSOption extends OptionsWidget {
  const VideoFPSOption(FlutterRtmpStreamer streamer, StreamingState streamingState, {Key? key})
      : super(streamer, streamingState, key: key);
...
class H264ProfileOption extends OptionsWidget {
  const H264ProfileOption(FlutterRtmpStreamer streamer, StreamingState streamingState, {Key? key})
      : super(streamer, streamingState, key: key);
  ...
  @override
  Widget build(BuildContext context) {
    final selected = list.firstWhere((b) => b.value == streamingState.streamingSettings.h264profile,
        orElse: () => const NamedValue("", ""));
...
class VideoStabilizationModeOption extends OptionsWidget {
  const VideoStabilizationModeOption(FlutterRtmpStreamer streamer, StreamingState streamingState,
      {Key? key})
      : super(streamer, streamingState, key: key);
  ...
  Widget build(BuildContext context) {
    final selected = list.firstWhere(
        (b) => b.value == streamingState.streamingSettings.stabilizationMode,
        orElse: () => const NamedValue("", ""));
...
class AudioBitrateOption extends OptionsWidget {
  const AudioBitrateOption(FlutterRtmpStreamer streamer, StreamingState streamingState, {Key? key})
      : super(streamer, streamingState, key: key);
  ...
  Widget build(BuildContext context) {
    final selected = bitrates.firstWhere(
        (b) => b.value == streamingState.streamingSettings.audioBitrate,
        orElse: () => const NamedValue(0, ""));
...
class AudioSampleRateOption extends OptionsWidget {
  const AudioSampleRateOption(FlutterRtmpStreamer streamer, StreamingState streamingState,
      {Key? key})
      : super(streamer, streamingState, key: key);
  ...
  Widget build(BuildContext context) {
    final selected = list.firstWhere(
        (b) => b.value == streamingState.streamingSettings.audioSampleRate,
        orElse: () => const NamedValue(0, ""));
...
class AudioChannelsOption extends OptionsWidget {
  const AudioChannelsOption(FlutterRtmpStreamer streamer, StreamingState streamingState, {Key? key})
      : super(streamer, streamingState, key: key);
  ...
  Widget build(BuildContext context) {
    final selected = list.firstWhere(
        (b) => b.value == streamingState.streamingSettings.audioChannelCount,
        orElse: () => const NamedValue(0, ""));
